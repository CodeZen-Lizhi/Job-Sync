...
import { Check, FileText, Link2, Plus, Save, Star, Trash2, X } from "lucide-vue-next";
        ...
        <div class="ui-section-header">
          <div>
            ...
            <p class="ui-section-copy">
              {{ selectedResume?.is_default ? "默认简历" : isCreating ? "Markdown 简历" : "非默认简历" }}
            </p>
          </div>
          <div class="flex flex-wrap items-center gap-2">
            ...
            <button class="ui-btn-primary inline-flex items-center gap-2 px-3 py-1.5 text-xs" :disabled="!canSave || (!isCreating && !isDirty)" @click="saveResume">
          ...
          <aside class="space-y-3">
            <section class="ui-panel-muted p-4">
              <div class="flex items-center justify-between gap-2">
                ...
                <button class="ui-btn-secondary px-2.5 py-1 text-xs" :disabled="!selectedResume" @click="openLinkModal">添加</button>
              </div>
