...
const triggerClass = computed(() =>
  isWorkspace.value
    ? "group relative flex min-h-10 w-full items-center justify-between gap-3 rounded-md border border-border/90 bg-white px-3 py-2 text-sm text-content-primary transition-colors duration-150 hover:border-border-strong hover:bg-slate-50 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60"
...
const triggerOpenClass = computed(() => (isWorkspace.value ? "border-border-glow bg-white ring-4 ring-border-glow/10" : "border-border-glow bg-white ring-4 ring-border-glow/10"));
...
const optionStateClass = computed(() => ({
  disabled: isWorkspace.value ? "cursor-not-allowed opacity-50" : "cursor-not-allowed opacity-50",
  hover: isWorkspace.value ? "hover:bg-slate-50" : "hover:bg-slate-50",
  selected: isWorkspace.value ? "bg-border-glow/10 text-content-primary ring-1 ring-inset ring-border-glow/20" : "bg-border-glow/10 text-content-primary ring-1 ring-inset ring-border-glow/20",
  active: isWorkspace.value ? "bg-slate-50 text-content-primary" : "bg-slate-50 text-content-primary",
}));
